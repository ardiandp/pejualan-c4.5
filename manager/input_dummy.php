                            ...
                            <div class="col-lg-8">
                                <div class="card" >
                                    <div class="card-header  bg-primary text-white">
                                        <strong>Input Data </strong> Dummy
                                    </div>
                                    <div class="card-body card-block ">
                                        <form action="save_dummy.php" method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				echo "<option value='$r[nilai_atribut]'>$r[nilai_atribut]</option>";
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-4">
                                                   <input type="text" name="tahun1" class="form-control" placeholder="Dari Tahun">
                                                   
                                                </div>
                                                 <div class="col-12 col-md-4">
                                                    <input type="text" name="tahun2" class="form-control" placeholder="Sampai Tahun">
                                                 </div>
                                            </div>                                       
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-4">
                                                   <input type="text" name="harga1" class="form-control" placeholder="Harga Terkecil">
                                                   
                                                </div>
                                                 <div class="col-12 col-md-4">
                                                    <input type="text" name="harga2" class="form-control" placeholder="Harga Tertinggi">
                                                 </div>                                             
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label">Jumlah Perulagan</label>
                                                </div>
                                                <div class="col-12 col-md-4">
                                                   <input type="text" name="record" class="form-control" placeholder="Jumlah Perulangan">
